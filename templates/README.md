...
Template files used by the local scripts and workflows.
...
**Do not rename states** -- the tracker scripts depend on these exact IDs. You can add aliases if you encounter new variants that should map to an existing state.
